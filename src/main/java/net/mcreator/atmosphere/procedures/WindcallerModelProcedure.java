...
**/
public class WindcallerModelProcedure extends AnimatedGeoModel<WindcallerEntity> {
	@Override
	...
	public ResourceLocation getTextureResource(WindcallerEntity entity) {
		return new ResourceLocation("atmosphere", "textures/entities/windcaller.png");
	}
