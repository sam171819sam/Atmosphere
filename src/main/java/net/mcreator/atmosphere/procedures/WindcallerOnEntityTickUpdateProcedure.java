...
public class WindcallerOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!(!world.getEntitiesOfClass(SquallEntity.class, AABB.ofSize(new Vec3((entity.getX()), (entity.getY()), (entity.getZ())), 20, 20, 20),
				e -> true).isEmpty())) {
			if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((entity.getX()), (entity.getY()), (entity.getZ())), 8, 8, 8), e -> true)
					.isEmpty()) {
				if (Mth.nextInt(RandomSource.create(), 1, 1000) >= 1) {
					...
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = new SquallEntity(AtmosphereModEntities.SQUALL.get(), _level);
						entityToSpawn.moveTo((entity.getX() - Mth.nextInt(RandomSource.create(), 2, 4)), (entity.getY() + 1),
								(entity.getZ() - Mth.nextInt(RandomSource.create(), 1, 5)), 0, 0);
						entityToSpawn.setYBodyRot(0);
						entityToSpawn.setYHeadRot(0);
						entityToSpawn.setDeltaMovement(0, 0, 0);
						if (entityToSpawn instanceof Mob _mobToSpawn)
					...
					if (world instanceof ServerLevel _level)
						_level.sendParticles(ParticleTypes.WHITE_ASH, (entity.getX() - Mth.nextInt(RandomSource.create(), 2, 4)), (entity.getY() + 1),
								(entity.getZ() - Mth.nextInt(RandomSource.create(), 1, 5)), 20, 1, 1, 1, 1);
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = new SquallEntity(AtmosphereModEntities.SQUALL.get(), _level);
