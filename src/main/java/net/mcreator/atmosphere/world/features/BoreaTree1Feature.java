...
public class BoreaTree1Feature extends Feature<NoneFeatureConfiguration> {
	public static BoreaTree1Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BoreaTree1Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("atmosphere:borea_tree_1", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("atmosphere:borea_tree_1", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
