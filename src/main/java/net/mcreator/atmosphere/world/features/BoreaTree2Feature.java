...
public class BoreaTree2Feature extends Feature<NoneFeatureConfiguration> {
	public static BoreaTree2Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new BoreaTree2Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("atmosphere:borea_tree_2", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("atmosphere:borea_tree_2", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
