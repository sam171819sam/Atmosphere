package net.mcreator.atmosphere.block.entity;
...
public class BlosoreaFlowerTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BlosoreaFlowerTileEntity(BlockPos pos, BlockState state) {
		super(TileRegistry.BLOSOREA_FLOWER.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<BlosoreaFlowerTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<BlosoreaFlowerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("blosorea_flower");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Blosorea Flower");
	}
