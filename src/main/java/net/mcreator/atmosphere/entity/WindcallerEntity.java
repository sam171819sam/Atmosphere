...
import net.mcreator.atmosphere.procedures.WindcallerOnEntityTickUpdateProcedure;
import net.mcreator.atmosphere.procedures.WindcallerEntityIsHurtProcedure;
import net.mcreator.atmosphere.init.AtmosphereModItems;
import net.mcreator.atmosphere.init.AtmosphereModEntities;

public class WindcallerEntity extends Monster implements IAnimatable {
	...
	public WindcallerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AtmosphereModEntities.WINDCALLER.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(3, new AvoidEntityGoal<>(this, Player.class, (float) 2, 1, 1));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(AtmosphereModItems.SOFT_AMULET.get()));
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		WindcallerEntityIsHurtProcedure.execute(this.level, this);
	...
	public void baseTick() {
		super.baseTick();
		WindcallerOnEntityTickUpdateProcedure.execute(this.level, this);
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(WindcallerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
