...
public class CroakerEntity extends PathfinderMob implements IAnimatable {
	private AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private boolean swinging;
	private long lastSwing;
	public String animationprocedure = "empty";

	public CroakerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AtmosphereModEntities.CROAKER.get(), world);
	}

	public CroakerEntity(EntityType<CroakerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void baseTick() {
		super.baseTick();
		CroakerOnEntityTickUpdateProcedure.execute(this.level, this);
	}

	public static void init() {
		SpawnPlacements.register(AtmosphereModEntities.CROAKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CroakerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
