...
import net.mcreator.atmosphere.procedures.FireburstOnInitialEntitySpawnProcedure;
import net.mcreator.atmosphere.procedures.FireburstOnEntityTickUpdateProcedure;
...
public class FireburstEntity extends PathfinderMob implements IAnimatable {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason,
		...
		FireburstOnInitialEntitySpawnProcedure.execute(world, this.getX(), this.getY(), this.getZ(), this);
		return retval;
	}
	...
	public void baseTick() {
		super.baseTick();
		FireburstOnEntityTickUpdateProcedure.execute(this.level, this);
	}
