...
public class AtmosphereModMenus {
	...
	public static final RegistryObject<MenuType<WitchPoolGUIMenu>> WITCH_POOL_GUI = REGISTRY.register("witch_pool_gui",
			() -> IForgeMenuType.create(WitchPoolGUIMenu::new));
	public static final RegistryObject<MenuType<WitchCrushingGUIMenu>> WITCH_CRUSHING_GUI = REGISTRY.register("witch_crushing_gui",
			() -> IForgeMenuType.create(WitchCrushingGUIMenu::new));
}
