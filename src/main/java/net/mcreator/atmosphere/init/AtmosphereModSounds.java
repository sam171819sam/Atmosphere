...
public class AtmosphereModSounds {
	...
	public static final RegistryObject<SoundEvent> DEATH_WHISTLE = REGISTRY.register("death_whistle",
			() -> new SoundEvent(new ResourceLocation("atmosphere", "death_whistle")));
	public static final RegistryObject<SoundEvent> FIRE_BURST = REGISTRY.register("fire_burst",
			() -> new SoundEvent(new ResourceLocation("atmosphere", "fire_burst")));
}
